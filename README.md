...
## 主張
以下のアンチパターンを参考に、デメリットを最小に軽減する仕組みをもったアプリ、SaaS、ツールがジュニアエンジニア向けに提供されていない。
...
- 全日オフィス勤務
生産性の向上目的で出社率を増やす目的に組み込まれているため育成の観点では有効と思われる。しかし、マネージャーの業務がリモートワークに最適化された後の状況では通勤時間を作業時間に当てたいという状況も考えられる
